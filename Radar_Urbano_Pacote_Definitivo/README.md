...
| `docs/dicionario.xlsx` | Dicionário em Excel com tabelas, campos, domínios e relacionamentos |
| `docs/DER.png` | Imagem do Diagrama Entidade-Relacionamento |
...
| `database/radar_urbano_ocorrencias_teste.csv` | Massa única com 20 registros fictícios |
...
│   └── styles.css
├── database/
│   ├── radar_urbano_ocorrencias_teste.csv
│   └── arquivos SQL
├── docs/
│   ├── dicionario.xlsx
│   ├── DER.png

...
| CSV duplicado em duas pastas. | O guia pede evitar duplicações desnecessárias. | Manter apenas `database/radar_urbano_ocorrencias_teste.csv`. | Inventário final do pacote. |
